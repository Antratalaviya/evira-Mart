...
const register = async (req, res) => {
    try {
        ...
        if (user) {
            return commonUtils.sendError(req, res, { success: false, message: AppString.USER_ALREADY_EXIST }, httpStatus.CONFLICT)
        }
...
const login = async (req, res) => {
    ...
    if (!valid) {
        return commonUtils.sendError(req, res, { success: false, message: AppString.INVALID_PASS }, httpStatus.FORBIDDEN)
    }
    ...
    if (user.isProfileCompleted == 'not-Completed' || user.isProfileCompleted == 'step-1') {
        return commonUtils.sendError(req, res, { success: false, message: AppString.PROFILE_INCOMPLETED }, httpStatus.UNAUTHORIZED)
    }
    return commonUtils.sendSuccess(req, res, { success: true, token: tokens.accessToken }, httpStatus.OK)
    // } catch (error) {
    //     return commonUtils.sendError(req, res, { success: false, error: AppString.SOMETHING_WENT_WRONG }, httpStatus.INTERNAL_SERVER_ERROR)
    // }
}
...
const postProfile = async (req, res) => {
    ...
    try {
        ...
        if (user) {
            ...
            return commonUtils.sendSuccess(req, res, { success: true, message: AppString.PROFILE_STEP_1 }, httpStatus.OK)
        }
        return commonUtils.sendError(req, res, { success: false, message: AppString.USER_NOT_EXIST }, httpStatus.NOT_FOUND)
    } catch (error) {
        return commonUtils.sendError(req, res, { success: false, error: AppString.SOMETHING_WENT_WRONG }, httpStatus.INTERNAL_SERVER_ERROR)
...
const addSecret = async (req, res) => {
    try {
        ...
        if (exist) {
            ...
            return commonUtils.sendSuccess(req, res, { success: true, message: AppString.PROFILE_COMPLETED }, httpStatus.OK)
        }
        return commonUtils.sendError(req, res, { success: false, message: AppString.USER_NOT_EXIST }, httpStatus.NOT_FOUND)
    } catch (error) {
        return commonUtils.sendError(req, res, { success: false, error: AppString.SOMETHING_WENT_WRONG }, httpStatus.INTERNAL_SERVER_ERROR)
...
const checkStatus = async (req, res) => {
    try {
        ...
        if (exist) {
            ...
            return commonUtils.sendSuccess(req, res, { success: true, message: message }, httpStatus.OK)
        }
        return commonUtils.sendError(req, res, { success: false, message: AppString.USER_NOT_EXIST }, httpStatus.NOT_FOUND)
    } catch (error) {
        return commonUtils.sendError(req, res, { success: false, error: AppString.SOMETHING_WENT_WRONG }, httpStatus.INTERNAL_SERVER_ERROR)
...
const sendOtp = async (req, res) => {
    try {
        ...
        if (exist) {
            ...
            return commonUtils.sendSuccess(req, res, { success: true, message: AppString.OTP_SENT }, httpStatus.OK)
        }
        return commonUtils.sendError(req, res, { success: false, message: AppString.USER_NOT_EXIST }, httpStatus.NOT_FOUND)
    } catch (error) {
        return commonUtils.sendError(req, res, { success: false, error: AppString.SOMETHING_WENT_WRONG }, httpStatus.INTERNAL_SERVER_ERROR)
...
const verifyOtp = async (req, res) => {
    try {
        ...
        if (exist) {
            ...
            if (otpExist) {
                if (otpExist.otp === otp) {
                    return commonUtils.sendSuccess(req, res, { success: true, message: AppString.OTP_VERIFIED }, httpStatus.OK)
                }
                return commonUtils.sendError(req, res, { success: false, message: AppString.OTP_NOT_MATCHED }, httpStatus.FORBIDDEN)
            }
            return commonUtils.sendError(req, res, { success: false, message: AppString.OTP_EXPIRED }, httpStatus.FORBIDDEN)
        }
        return commonUtils.sendError(req, res, { success: false, message: AppString.USER_NOT_EXIST }, httpStatus.NOT_FOUND)
    } catch (error) {
        return commonUtils.sendError(req, res, { success: false, error: AppString.SOMETHING_WENT_WRONG }, httpStatus.INTERNAL_SERVER_ERROR)
...
const resetPassword = async (req, res) => {
    try {
        ...
        if (password !== confirmPassword) {
            return commonUtils.sendError(req, res, { success: false, message: AppString.PASS_NOT_MATCHED }, httpStatus.BAD_REQUEST)
        }
        let exist = await userService.getUserById(req.user._id)
        if (!exist) {
            return commonUtils.sendError(req, res, { success: false, message: AppString.USER_NOT_EXIST }, httpStatus.NOT_FOUND)
        }
        let update = await userService.updateUser(exist._id, { password: password })
        if (update) {
            return commonUtils.sendSuccess(req, res, { success: true, message: AppString.PASS_UPDATED }, httpStatus.OK)
        }
    } catch (error) {
        return commonUtils.sendError(req, res, { success: false, error: AppString.SOMETHING_WENT_WRONG }, httpStatus.INTERNAL_SERVER_ERROR)
    }
...
const getAllUser = async (req, res) => { // query : page limit sort
    ...
    return commonUtils.sendSuccess(req, res, { success: true, message: AppString.USER_RETRIEVED, users }, httpStatus.OK)
}
const getUser = async (req, res) => {  //params : id
    const { id } = req.params
    ...
    return commonUtils.sendSuccess(req, res, { success: true, message: AppString.USER_RETRIEVED, user }, httpStatus.OK)
}
...
const deleteUser = async (req, res) => {
    ...
    return commonUtils.sendSuccess(req, res, { success: true, message: AppString.USER_DELETED }, httpStatus.OK)
}
...
const updateProfile = async (req, res) => {
    ...
    return commonUtils.sendSuccess(req, res, { success: true, message: AppString.USER_UPDATED }, httpStatus.OK)
...
const getAllWishList = async (req, res) => {
    ...
    for (let i = 0; i < length; i++) {
        ...
        let product = await productService.getAllProd({ matchCriteria2, page, limit })
        if (product) products.push(product[0])
    }
    if (products == []) {
        return commonUtils.sendError(req, res, { success: true, message: AppString.PRODUCT_NOT_AVAILABLE_WISH }, httpStatus.OK)
    }
...
const getCatWishList = async (req, res) => {
    ...
    for (let i = 0; i < length; i++) {
        ...
        let product = await productService.getAllProd({ matchCriteria1, matchCriteria2, page, limit })
        if (product) products.push(product[0])
    }
    if (products == []) {
        return commonUtils.sendError(req, res, { success: true, message: AppString.PRODUCT_NOT_AVAILABLE_WISH }, httpStatus.OK)
